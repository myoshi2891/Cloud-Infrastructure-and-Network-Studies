// __tests__/gcl/professional-agentic-architect/section1/NavBar.test.tsx
// @vitest-environment jsdom
import { fireEvent, render } from '@testing-library/react';
import { act } from 'react';
import { afterEach, beforeEach, describe, expect, it, vi } from 'vitest';
import { NavBar } from '@/app/gcl/professional-agentic-architect/section1/NavBar';
import { NAV_ITEMS } from '@/app/gcl/professional-agentic-architect/section1/constants';
...
describe('Professional Agentic Architect Section 1 NavBar', () => {
    ...
    it('リンククリックで active クラスが反映され、対象要素にフォーカスが当たる', () => {
        render(<NavBar />);
        const targetItem = navItemAt(3);
