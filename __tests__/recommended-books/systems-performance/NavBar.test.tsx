// __tests__/recommended-books/systems-performance/NavBar.test.tsx
// @vitest-environment jsdom
import { fireEvent, render, screen } from '@testing-library/react';
import { act } from 'react';
import { afterEach, beforeEach, describe, expect, it, vi } from 'vitest';
import { NavBar } from '@/app/recommended-books/systems-performance/NavBar';
import { NAV_ITEMS } from '@/app/recommended-books/systems-performance/constants';
...
describe('systems-performance NavBar', () => {
    ...
    it('全41項目の目次リンクが存在し、lvl3クラスが正しく割り当てられている', () => {
        render(<NavBar />);
