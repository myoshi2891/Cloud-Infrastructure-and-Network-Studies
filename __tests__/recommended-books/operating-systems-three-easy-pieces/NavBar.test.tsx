// __tests__/recommended-books/operating-systems-three-easy-pieces/NavBar.test.tsx
// @vitest-environment jsdom
import { fireEvent, render, screen } from '@testing-library/react';
import { act } from 'react';
import { afterEach, beforeEach, describe, expect, it, vi } from 'vitest';
import { NavBar } from '@/app/recommended-books/operating-systems-three-easy-pieces/NavBar';
import { NAV_ITEMS } from '@/app/recommended-books/operating-systems-three-easy-pieces/constants';
...
describe('operating-systems-three-easy-pieces NavBar', () => {
    ...
    it('全75項目の目次リンクが存在し、lvl3クラスが正しく割り当てられている', () => {
        render(<NavBar />);
    ...
    it('IntersectionObserver のコールバックで最も画面上部に近い交差要素が active になる', () => {
        ...
        act(() => {
            observerCallback!([
                entry(navItemAt(3).id, 120),
                entry(navItemAt(2).id, 40),
            ]);
        });
    ...
    it('モバイルトグルボタンがaria-expandedを正しく切り替える', () => {
        render(<NavBar />);
