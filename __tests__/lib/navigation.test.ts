...
describe('toNavTree', () => {
    ...
    describe('実 EXAMS との結合', () => {
        ...
        it('GCP グループに ace, agwa, cdl, genai, pca, pcne, hands-on, professional-agentic-architect 試験が含まれる', () => {
            // Arrange & Act
            const result = toNavTree(EXAMS);
            ...
            expect(ids).toEqual(['ace', 'agwa', 'cdl', 'genai', 'hands-on', 'pca', 'pcd', 'pcne', 'professional-agentic-architect']);
        });
